...
[사용자 생성 콘텐츠 관리]
커뮤니티 글과 댓글에 신고·차단이 있습니다. 글을 열고 오른쪽 위
메뉴에서 누릅니다.
- 신고: 사유 6종 중 고름. 운영자 화면(/admin/community)으로 들어옴
- 차단: 누르는 즉시 그 사람 글이 안 보입니다. 서버 정책(RLS)으로
  걸러서 화면 새로고침을 기다릴 필요가 없습니다
운영자가 확인하고 내리는 데 24시간을 넘기지 않습니다.
