...
const QA = [
  ...
  {
    q: "초대 코드가 뭔가요?",
    a: "DJ 나 크루에게 받는 코드입니다. 예매할 때 넣으면 게스트 가격이 적용되고, 누구 초대로 왔는지 크루가 알 수 있어요. 코드를 받지 않았다면 비워 두셔도 예매됩니다.",
  },
  {
    q: "테이블은 어떻게 잡나요?",
    a: "파티 상세의 테이블 칸을 보고 크루 인스타로 문의하시면 됩니다. 앱에서는 결제하지 않습니다. 테이블을 잡으면 적힌 인원까지 입장비가 없습니다.",
  },
  {
    q: "환불하고 싶어요",
    a: "파티 시작 7일 전부터는 환불되지 않습니다. 인원에 맞춰 술·자리·인력을 미리 잡기 때문이에요. 그 전이라면 주최 크루가 기준에 따라 처리하니 파티 상세의 크루로 연락해 주세요. 입금 전이라면 내 티켓에서 직접 취소할 수 있습니다.",
  },
];
