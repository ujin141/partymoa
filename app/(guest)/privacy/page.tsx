...
const SECTIONS: { h: string; body: React.ReactNode }[] = [
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          결제 수단 정보는 받지 않습니다. 입금은 호스트 계좌로 직접
          이체하는 방식입니다.
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        <p>
          <b className="text-ink">예매한 파티의 호스트가 봅니다.</b> 이름,
          연락처, 인원, 차수, 금액, 입금·입장 상태를 봅니다. 입금을 확인하고
          현장에서 입장을 처리하려면 필요합니다.
        </p>
        <p className="mt-3">
          다른 호스트는 볼 수 없습니다. 다른 손님도 볼 수 없습니다.
        </p>
        <p className="mt-3">
          파티모아 운영자는 입금 대조와 문의 처리를 위해 가입 정보와 예매
          기록을 볼 수 있습니다. 그 밖의 용도로는 보지 않습니다.
        </p>
        <p className="mt-3">
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          다만 이미 확정된 예매는 호스트의 정산 근거라, 행사가 끝나기 전에는
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          특정 파티의 예매·환불은 그 파티의 호스트가 처리합니다. 파티 상세
          화면에서 호스트 연락처를 확인하세요.
        </p>
      </>
    ),
