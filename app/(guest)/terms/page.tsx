  ...
  const SECTIONS: { h: string; body: React.ReactNode }[] = [
    {
      ...
      body: (
        <>
          <p>
            파티모아는 파티를 여는 크루와 가려는 사람을 잇는{" "}
            <b className="text-ink">중개 서비스</b>입니다. 파티를 직접 열지
            않습니다.
          </p>
          <p className="mt-3">
            파티의 내용·장소·시간·가격·운영은 주최 크루가 정하고 책임집니다.
            예매가 확정되면 계약은{" "}
            <b className="text-ink">손님과 주최 크루 사이</b>에 생깁니다.
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      body: (
        <p>
          ...
          금액의 {fee}%를 크루에게 수수료로 청구합니다. 손님이 따로 내는 돈은
          없습니다.
        </p>
      ),
    },
      ...
      body: (
        <>
          <p>
            ...
            생기는 일, 크루와 손님 사이의 분쟁, 크루가 파티를 취소하거나
